 ...
 */
struct Event: Codable, TableRecord, FetchableRecord, MutablePersistableRecord {
    ...
    // Define column names (optional but recommended)
        enum Columns {
            ...
            static let event_name = Column("event_name")
            static let event_description = Column("event_description")
            static let event_location = Column("event_location")
            static let organizations = Column("organizations")
            static let rsvp = Column("rsvp")
            static let event_date = Column("event_date")
            static let event_time = Column("event_time")
            static let event_all_day = Column("event_all_day")
            static let event_start_time = Column("event_start_time")
            static let useful_event_start_time = Column("useful_event_start_time")
            static let event_end_time = Column("event_end_time")
            static let useful_event_end_time = Column("useful_event_end_time")
            static let tags = Column("tags")
            static let event_private = Column("event_private")
            static let repeats = Column("repeats")
            static let event_image = Column("event_image")
            static let is_draft = Column("is_draft")
        }

...
/**
 * This is a composable function that represents our Day View in the
 * Calendar.
 *
 * @param modifier Modifier to be applied to the screen layout.
 */
...
@Composable
fun DayViewScreen(modifier: Modifier = Modifier){
    Column(
...
/**
 * This is a composable function that represents our Week View in the
 * Calendar.
 *
 * @param modifier Modifier to be applied to the screen layout.
 */
@Composable
fun WeekViewScreen(modifier: Modifier = Modifier){
    Column(
        modifier = modifier.fillMaxSize(),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
